    ...
    <link href="css/animate.css" rel="stylesheet">
      ...
      <body id="top">
                ...
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2">
                  <nav class="pull">
                    <ul class="top-nav">
                      ...
                      <li><a href="#features">Projects <span class="indicator"><i class="fa fa-angle-right"></i></span></a></li>
                      <li><a href="#responsive">Design & mirr.OS <span class="indicator"><i class="fa fa-angle-right"></i></span></a></li>
            ...
            <div class="container">
              ...
              <div class="row font-monopoly">
                <div class="col-md-8 col-md-offset-2 text-center inner">
                  <h1 class="animated fadeInDown">STU<span style="color:white">DIO</span></h1>
                  <p class="animated fadeInUp delay-05s" style="color:white">meet the future.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                  <a href="http://tympanus.net/codrops/?p=19439" class="learn-more-btn">View More</a>
                </div>
              </div>
            </div>
          </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-8 col-md-offset-2 wp1">
                <h1 class="arrow">About STUDIO</h1>
              ...
              <div class="col-md-12">
                ...
                <div class="features-wrapper">
                  ...
                  <div class="col-md-4 wp2 delay-1s">
                    ...
                    <h2>May KING</h2>
                    <p>May KING은 2가지 의미를 가지고 있습니다. 첫 번째는 있는 그대로 ‘(Everyone) may (be)  king, 모든 사람은 왕일지도 모른다.’ 입니다. 즉, 사람은 누구나 가능성을 지니고 있다는 의미입니다. 두 번째는 같은 발음이 나는 Making, 제작입니다.
                      저희는 정보소외계층에게 자신이 필요한 것들을 기획하고 만드는 활동을 지원할 것입니다. 그리고 그 과정에서 다양한 정보교육을 실시하여 정보격차를 줄여나가고자 합니다.</p>
                  </div>
        ...
        <section class="subscribe text-center">
          <div class="container">
            <h1><i class="fa fa-paper-plane"></i><span>E-mail</span></h1>
            <form action="#">
              <input type="text" name="" value="" placeholder="" required>
              <input type="submit" href="mailto:beomsoo@studiomirr.com" name="" value="Send">
            </form>
          </div>
        </section>
            ...
            <div class="row contact-details">
              ...
              <div class="col-md-4">
                <div class="light-box box-hover">
                  ...
                  <p><a href="#">k1a11220@naver.com</a></p>
                </div>
              </div>
            </div>
            <div class="row">
